            ...
            return (
              ...
              >
                <CardContent className="p-6 text-center sm:p-8">
                  <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 transition-transform group-hover:scale-110 sm:mb-6 sm:h-16 sm:w-16">
