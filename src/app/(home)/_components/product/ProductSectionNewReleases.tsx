...
import { getNewReleasesSectionProducts } from "../../actions";
...
export default async function ProductSectionNewReleases() {
  ...
  return (
    <section id="home-produtos-novidades" className="py-12 bg-background">
        ...
        {displayProducts.length > 0 ? (
          ...
          <div className="border border-dashed border-border rounded-lg p-10 text-center">
            <p className="text-muted-foreground text-sm md:text-base">
              Nenhuma novidade disponivel no momento.
            </p>
          </div>
        )}
      </div>
